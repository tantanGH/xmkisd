...
def main():
  ...
  parser.add_argument("-dt", "--deband_threshold", help="band detection threshold (0.00003 - 0.5, default:0.005)", type=float, default=0.005)
  parser.add_argument("-dr", "--deband_range", help="band detection range pixels (default:16)", type=int, default=16)
